...
class ServiceOrder(models.Model):
    ...
    # ch48: every portal request filters on this (the security XML's record
    # rule), so it earns an index even though it's invisible on our own
    # four-row table; production doesn't stay four rows.
