...
try {
  ...
  const stubRoute = '/docs/09-integrator-craft/48-performance/';
  ...
  assert.match(sitemapBody, /\/docs\/09-integrator-craft\/47-migrations\/<\/loc>/);
  assert.doesNotMatch(sitemapBody, /\/docs\/09-integrator-craft\/48-performance/);
