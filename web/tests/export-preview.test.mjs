...
try {
  ...
  const stubRoute = '/docs/09-integrator-craft/47-migrations/';
  ...
  assert.match(sitemapBody, /\/docs\/08-oca-way\/46-refactor-into-an-oca-quality-module\/<\/loc>/);
  assert.doesNotMatch(sitemapBody, /\/docs\/09-integrator-craft\/47-migrations/);
