...
try {
  ...
  const stubRoute = '/docs/08-oca-way/43-oca-safari/';
  ...
  assert.match(sitemapBody, /\/docs\/07-frontend-owl\/42-website-snippets-pos-survey\/<\/loc>/);
  assert.doesNotMatch(sitemapBody, /\/docs\/08-oca-way\/43-oca-safari/);
